                ...
                <tbody>
                    ...
                    foreach ($results as $row) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?page=mmb-smtp-groups&action=edit&group_id=<?php echo esc_attr($row->id); ?>"><?php esc_html_e('Edit', 'multimail-blaster'); ?></a> | 
                                <a href="?page=mmb-smtp-groups&action=delete&group_id=<?php echo esc_attr($row->id); ?>" onclick="return confirm('<?php esc_html_e('Are you sure you want to delete this group?', 'multimail-blaster'); ?>');"><?php esc_html_e('Delete', 'multimail-blaster'); ?></a>
                            </td>
                        </tr>
                        <?php
                    }

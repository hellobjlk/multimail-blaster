...
function mmb_create_tables() {
    ...
    // SQL for creating the Recipients table with Group ID
    $sql_recipients_table = "CREATE TABLE IF NOT EXISTS $recipients_table (
        ...
        recipient_group_id mediumint(9) DEFAULT NULL, -- NEW: Group association
        status varchar(20) DEFAULT 'active',
        PRIMARY KEY  (id),
        FOREIGN KEY (recipient_group_id) REFERENCES $recipient_groups_table(id) -- Group relationship
    ) $charset_collate;";
...
// Hook the function to create tables and insert default settings when the plugin is activated
